      ...
      <TableRow>
        ...
        {headLabels.map((label, index) => (
          <TableCell
            key={index}
            align="left"
            sortDirection={orderBy === headLabels[0] ? order : false}
          >
            <TableSortLabel
              active={orderBy === headLabels[0]}
              direction={orderBy === headLabels[0] ? order : "asc"}
              onClick={createSortHandler(headLabels[0])}
            >
              {label}
              {orderBy === headLabels[0] ? (
